...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "mcohen-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/hlct"
  #   chef.validation_client_name = "hlct-validator"
  #   chef.validation_key_path = ".chef/hlct-validator.pem"
  # end
end
